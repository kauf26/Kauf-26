  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] flex flex-col">
      ...
      <div className="bg-blue-600/10 border-b border-blue-500/20 px-4 py-2 text-center text-sm text-blue-300">
        <span>Free trial: <strong>28 days remaining</strong> — 1% fee applies after trial</span>
      </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-start justify-between gap-2">
                  ...
                  {p.status === "sold_out" && (
                    <span className="bg-gray-700 text-gray-400 text-xs px-2 py-0.5 rounded-full shrink-0">Sold</span>
                  )}
                </div>
      ...
      <div className="flex-1 px-4 py-5 space-y-4">
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="bg-blue-500/10 border border-blue-500/20 rounded-2xl p-4">
            ...
            <div className="text-blue-600 text-xs mt-1">Total Fees (1%)</div>
          </div>
        </div>
      ...
      <div className="flex-1 px-4 py-5 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          {[
            ...
            { label: "Trial Days Left", value: "28", sub: "then 1% per sale", color: "from-orange-600/20 to-orange-500/10", border: "border-orange-500/20", text: "text-orange-400" },
          ].map(s => (
