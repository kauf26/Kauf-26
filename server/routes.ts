        ...
        messages: [
          {
            ...
            content: [
              {
                type: "text",
                text: "Analyze this product image carefully. Search your knowledge for an EXACT MATCH - the specific brand, model number, and product name. If you find an exact match, start the description with '[EXACT MATCH]' followed by the official product description. If you cannot identify the exact product, provide a compelling generic description. Return: 1) Product title - include exact brand/model if identified (e.g. 'Apple iPhone 15 Pro Max 256GB'), otherwise a descriptive title (max 10 words). 2) Description - exactly 3 sentences: If exact match found, start with '[EXACT MATCH]' then official specs/features. Otherwise: First sentence describes what it is. Second sentence highlights benefits. Third sentence mentions appeal to buyers. 3) exactMatch - true if you identified the specific product, false otherwise. Return JSON: {\"title\": \"...\", \"description\": \"...\", \"exactMatch\": boolean}",
              },
              {
                type: "image_url",
        ...
        messages: [
          {
            ...
            content: [
              {
                type: "text",
                text: "Analyze this product image carefully. Search your knowledge for an EXACT MATCH - the specific brand, model number, and product name. If you find an exact match, start the description with '[EXACT MATCH]' followed by the official product description. If you cannot identify the exact product, provide a compelling generic description. Return: 1) Product title - include exact brand/model if identified (e.g. 'Apple iPhone 15 Pro Max 256GB'), otherwise a descriptive title (max 10 words). 2) Description - exactly 3 sentences: If exact match found, start with '[EXACT MATCH]' then official specs/features. Otherwise: First sentence describes what it is. Second sentence highlights benefits. Third sentence mentions appeal to buyers. 3) Suggested retail price in USD. 4) exactMatch - true if you identified the specific product, false otherwise. Return JSON: {\"title\": \"...\", \"description\": \"...\", \"suggestedPrice\": number, \"exactMatch\": boolean}",
              },
              {
                type: "image_url",
                image_url: { url: image },
